                    ...
                    <div className="form__inner">
                        ...
                        <div className="form__inputs">
                            ...
                            <FormInput settingName='number' 
                                    ...
                                    key='number'
                            />
                            <FormInput settingName='position' 
                        ...
                        <div className="form__logo">
                            <FormSelectIconProps settingName="logoId"
                                                value={logoId}
                                                changeSetting={changeSetting}
                            />
                        </div>
                        ...
                        <div className="form__positions">
                            <FormSelect variants='left|center|right'
